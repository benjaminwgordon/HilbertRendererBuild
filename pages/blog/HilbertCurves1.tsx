...
const HilbertCurves1Metadata: BlogPostMetaDataType = {
  id: 1,
  slug: "HilbertCurves1",
  ...
  return (
    <div>
      ...
      <article className="text-xs">
        <p>
          I recently{" "}
          <a href="https://www.recurse.com/about">"never graduated"</a> from the
          Recurse Center, a self-directed, community-driven educational retreat
          for programmers in New York City. The Recurse Center promotes a
          self-directed approach to learning, where there are no teachers or
          curriculum, rather, each student works on what interests them most,
          with the support of a community of other highly motivated students.
        </p>
        <p>
        ...
        <div className="max-w-lg max-h-72 mx-8">
